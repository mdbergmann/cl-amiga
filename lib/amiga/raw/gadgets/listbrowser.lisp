...
;;;
;;; 16 functions, 179 constants, 9 structs.
...
(amiga.ffi:define-binding-table "AMIGA.RAW.GADGETS.LISTBROWSER"
  ...
  ;; --- structures from gadgets/listbrowser.h ---
  (:struct "LB-ADD-NODE" 16   ; lbAddNode (gadgets/listbrowser.h)
    ("METHOD-ID" :u32 0)
    ("G-INFO" :fptr 4)
    ("NODE" :fptr 8)
    ("NODE-ATTRS" :fptr 12)
    )
  (:struct "LB-REM-NODE" 12   ; lbRemNode (gadgets/listbrowser.h)
    ("METHOD-ID" :u32 0)
    ("G-INFO" :fptr 4)
    ("NODE" :fptr 8)
    )
  (:struct "LB-EDIT-NODE" 16   ; lbEditNode (gadgets/listbrowser.h)
    ("METHOD-ID" :u32 0)
    ("G-INFO" :fptr 4)
    ("NODE" :fptr 8)
    ("NODE-ATTRS" :fptr 12)
    )
  (:struct "LB-SORT" 20   ; lbSort (gadgets/listbrowser.h)
    ("METHOD-ID" :u32 0)
    ("G-INFO" :fptr 4)
    ("COLUMN" :u32 8)
    ("DIRECTION" :u32 12)
    ("COMPARE-HOOK" :fptr 16)
    )
  (:struct "LB-SHOW-CHILDREN" 14   ; lbShowChildren (gadgets/listbrowser.h)
    ("METHOD-ID" :u32 0)
    ("G-INFO" :fptr 4)
    ("NODE" :fptr 8)
    ("DEPTH" :i16 12)
    )
  (:struct "LB-HIDE-CHILDREN" 14   ; lbHideChildren (gadgets/listbrowser.h)
    ("METHOD-ID" :u32 0)
    ("G-INFO" :fptr 4)
    ("NODE" :fptr 8)
    ("DEPTH" :i16 12)
    )
  (:struct "LB-DRAW-MSG" 24   ; LBDrawMsg (gadgets/listbrowser.h)
    ("METHOD-ID" :u32 0)
    ("RASTPORT" :fptr 4)
    ("DRAW-INFO" :fptr 8)
    ("BOUNDS" (:struct 8) 12)
  ...
  (:struct "LB-SORT-MSG" 30   ; LBSortMsg (gadgets/listbrowser.h)
    ("TYPE-A" :u32 0)
    ("DATA-A" (:struct 4) 4)
    ("INTEGER" :i32 4)
    ("TEXT" :fptr 4)
  ...
  (:struct "COLUMN-INFO" 10   ; ColumnInfo (gadgets/listbrowser.h)
    ("WIDTH" :i16 0)
    ("TITLE" :fptr 2)
    ("FLAGS" :u32 6)
    )
