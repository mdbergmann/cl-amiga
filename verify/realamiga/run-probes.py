...
With no arguments runs the standard set: storeprobe v1 v5 v8 v9 v14 v20,
fpuregtest fpu/sin, regtest, stackprobe.  Otherwise each argument is one
run, e.g. "storeprobe 5 noswap v9".
...
DEFAULT = ["storeprobe 3 noswap v1", "storeprobe 3 noswap v5", "storeprobe 3 noswap v8",
