...
(defvar *slot-test-pt* (%make-struct 'clos-test-pt 10 20))
...
(check "defclass slot-index x" 0 (gethash 'x (class-slot-index-table (find-class 'point))))
(check "defclass slot-index y" 1 (gethash 'y (class-slot-index-table (find-class 'point))))
