...
SHIPPED="lib/boot.lisp lib/clos.lisp lib/ffi.lisp lib/gray-streams.lisp lib/dev-commands.lisp lib/dev-repl.lisp lib/dev-tcp.lisp $(find lib/amiga -name '*.lisp' | LC_ALL=C sort | tr '\n' ' ')"
