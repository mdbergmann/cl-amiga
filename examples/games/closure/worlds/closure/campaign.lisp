...
;; The :image portraits (worlds/closure/gfx/, regenerated by
;; make-pack.lisp) show beside the character sheet, map-relative like
;; the spell icons.
(define-hero-class :warrior  :hp-dice "1d10+4" :damage "1d8" :ac 8
                             :image "gfx/hero-warrior.iff")
(define-hero-class :paladin  :hp-dice "1d10+3" :damage "1d8" :ac 8
                             :image "gfx/hero-paladin.iff")
(define-hero-class :rogue    :hp-dice "1d8+2"  :damage "1d6" :ac 9
                             :image "gfx/hero-rogue.iff")
(define-hero-class :bard     :hp-dice "1d8+2"  :damage "1d6" :ac 9
                             :singer t :image "gfx/hero-bard.iff")
